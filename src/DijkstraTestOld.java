...
class DijkstraTestOld {

	private static final boolean DEBUG_MODE = false;
	Random rand = new Random(0);
	int max = 5000;
	WeightedGraphOld testGraphStress = makeNewRandomGraph(max);
	WeightedGraphOld testGraph;
	WeightedGraphOld testGraph2;
	WeightedGraphOld testGraph3;
	...
	WeightedEdge[] edgesRandom = {
			...
			new WeightedEdge(13, 14, 8), new WeightedEdge(14, 15, 7), new WeightedEdge(15, 16, 9),
			new WeightedEdge(16, 17, 2), new WeightedEdge(17, 18, 6), new WeightedEdge(18, 19, 1),
			new WeightedEdge(19, 20, 3), new WeightedEdge(20, 21, 5), new WeightedEdge(21, 22, 4),
			new WeightedEdge(22, 23, 7), new WeightedEdge(23, 24, 8), new WeightedEdge(24, 25, 9),
			new WeightedEdge(25, 26, 2), new WeightedEdge(26, 27, 6), new WeightedEdge(27, 28, 1),
			new WeightedEdge(28, 29, 3), new WeightedEdge(29, 30, 5), new WeightedEdge(30, 31, 4),
			new WeightedEdge(31, 32, 7), new WeightedEdge(32, 33, 8), new WeightedEdge(33, 34, 9),
			new WeightedEdge(34, 35, 2), new WeightedEdge(35, 36, 6), new WeightedEdge(36, 37, 1),
			new WeightedEdge(37, 38, 3), new WeightedEdge(38, 39, 5), new WeightedEdge(39, 40, 4),
			new WeightedEdge(40, 41, 7), new WeightedEdge(41, 42, 8), new WeightedEdge(42, 43, 9),
			new WeightedEdge(43, 44, 13), new WeightedEdge(44, 45, 2), new WeightedEdge(45, 46, 6),
			new WeightedEdge(46, 47, 1), new WeightedEdge(47, 48, 3), new WeightedEdge(48, 49, 5),
			new WeightedEdge(49, 50, 4), new WeightedEdge(50, 51, 7), new WeightedEdge(51, 52, 8),
			new WeightedEdge(52, 53, 9), new WeightedEdge(53, 54, 2), new WeightedEdge(54, 55, 6),
			new WeightedEdge(55, 56, 1), new WeightedEdge(56, 57, 3), new WeightedEdge(57, 58, 5),
			new WeightedEdge(58, 59, 4), new WeightedEdge(59, 60, 7), new WeightedEdge(60, 61, 8),
			new WeightedEdge(61, 62, 9), new WeightedEdge(62, 63, 2), new WeightedEdge(63, 64, 6),
			new WeightedEdge(64, 65, 1), new WeightedEdge(65, 66, 3), new WeightedEdge(66, 67, 5),
			new WeightedEdge(67, 68, 4), new WeightedEdge(68, 69, 7), new WeightedEdge(69, 70, 8),
			new WeightedEdge(70, 71, 9), new WeightedEdge(71, 72, 2), new WeightedEdge(72, 73, 6),
			new WeightedEdge(73, 74, 1), new WeightedEdge(74, 75, 3), new WeightedEdge(75, 76, 5),
			new WeightedEdge(76, 77, 4), new WeightedEdge(77, 78, 7), new WeightedEdge(78, 79, 8),
			new WeightedEdge(79, 80, 9), new WeightedEdge(80, 81, 2), new WeightedEdge(81, 82, 6),
			new WeightedEdge(82, 83, 1), new WeightedEdge(83, 84, 3), new WeightedEdge(84, 85, 5),
			new WeightedEdge(85, 86, 4), new WeightedEdge(86, 87, 7), new WeightedEdge(87, 88, 8),
			new WeightedEdge(88, 89, 9), new WeightedEdge(89, 90, 2), new WeightedEdge(90, 91, 6),
			new WeightedEdge(91, 92, 1), new WeightedEdge(92, 93, 3), new WeightedEdge(93, 94, 5),
			new WeightedEdge(94, 95, 4), new WeightedEdge(95, 96, 7), new WeightedEdge(96, 97, 8),
			new WeightedEdge(97, 98, 9), new WeightedEdge(98, 99, 5), new WeightedEdge(99, 100, 2) };

	@Test
	void randomTest() {
		testGraph = new WeightedGraphOld(edgesRandom);
	...
	private WeightedGraphOld makeNewRandomGraph(int max) {
		WeightedGraphOld g = new WeightedGraphOld(null);
		int i = 0;
		while(i<max) {
	...
	void test1to12() {
		if (DEBUG_MODE) {
			...
			System.out.println(
					"═══════════════════════════════════════════════════════════════════════════════════════════════════\n");
			testGraph = new WeightedGraphOld(edges);
		} else {
			testGraph = new WeightedGraphOld(edges);
		}
		testGraph3 = new WeightedGraphOld(edges3);
	...
	void testCarrollGraph() {
		...
		testGraph1 = new WeightedGraphOld(edges1);
